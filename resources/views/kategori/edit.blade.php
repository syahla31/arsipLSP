...
<div class="container mx-auto p-4">
    <div class="text-center mb-6">
        <h1 class="text-3xl font-bold text-blue-900 font-serif">Edit Kategori</h1>
        ...
        <form action="{{ route('kategori.update', $kategori->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="keterangan" id="keterangan" rows="4"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">{{ old('keterangan', $kategori->keterangan) }}</textarea>
            </div>
            <div class="flex items-center gap-4">
                ...
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">Simpan Perubahan</button>
            </div>
        </form>
    </div>
</div>
