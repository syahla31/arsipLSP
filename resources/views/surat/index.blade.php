...
@section('content')
    <div class="container mx-auto">
        <div class="text-center mb-5 mt-10">
            <h1 class="text-2xl font-bold text-blue-900 font-serif mt-3">
                📜 Arsip Surat 📜
            </h1>
            <p class="text-gray-600 mt-2">Berikut ini adalah surat-surat yang telah terbit dan diarsipkan. Klik "Lihat" pada
                kolom aksi untuk menampilkan surat.</p>
            <div class="h-1 bg-blue-500 rounded-full mt-2 mx-auto w-60"></div>
        </div>

        <div class="flex justify-start mb-4">
            <form action="{{ route('surat.index') }}" method="GET" class="w-full md:w-2/3">
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative flex-grow">
                        <input type="text" name="search" id="search-input" placeholder="Cari berdasarkan judul surat..."
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="overflow-x-auto scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-blue-100">
                        ...
                        @forelse ($surats as $surat)
                            <tr class="border-b hover:bg-blue-50 transition">
                                ...
                                <td class="px-4 py-3 text-center">
                                    ...
                                    <span
                                        class="text-xs text-gray-500 block">{{ $surat->created_at->format('H:i:s') }}</span>
                                </td>
                                <td class="px-4 py-4 text-center align-middle">
                                    <div class="flex flex-nowrap justify-center items-center gap-2">
                                        ...
                                        <a href="{{ route('surat.show', $surat->id) }}"
                                            class="bg-pink-500 hover:bg-pink-600 text-white px-3 py-1 rounded-full shadow-md text-xs transition no-underline">Lihat</a>
                                    </div>
                                </td>
                            </tr>
                        @empty
        ...
        <div class="mt-3">
            <a href="{{ route('surat.create') }}"
                class="inline-flex items-center bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full shadow-lg transition duration-150 no-underline">
